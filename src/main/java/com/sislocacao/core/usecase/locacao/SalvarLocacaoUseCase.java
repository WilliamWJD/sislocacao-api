...
public class SalvarLocacaoUseCase implements SalvarLocacaoInputPort {
    ...
    public SalvarLocacaoUseCase(BuscarInquilinoPorIdInputPort buscarInquilinoPorIdInputPort, BuscarImovelPorIdInputPort buscarImovelPorIdInputPort, BuscarLocadorPorIdInputPort buscarLocadorPorIdInputPort, ILocacaoRepository locacaoRepository) {
